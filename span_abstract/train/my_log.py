...
_LOGGING = {
    ...
    "loggers": {
        "default": {"level": "DEBUG", "handlers": ["console", "file", "err_file", "perf", "track"]},
        "console": {"handlers": ["file", "err_file"], "level": "DEBUG"},
        "perf": {"handlers": ["perf"], "level": "DEBUG", "propagate": False},
        "track": {"handlers": ["track"], "level": "DEBUG", "propagate": False},
    },
}
